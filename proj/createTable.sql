...
CREATE TABLE delivery (
    ...
    delivery_status ENUM('Aguardando', 'Em Transito', 'Entregue') NOT NULL DEFAULT 'Aguardando',  -- Status da entrega
    delivery_date DATETIME,  -- Data da entrega
    CONSTRAINT fk_delivery_order FOREIGN KEY (id_order) REFERENCES orders (id_order) ON DELETE CASCADE,  -- Relacionamento com o pedido
